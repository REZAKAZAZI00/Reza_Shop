...
namespace Shop.Core.Convertors
{
    public class ImageConvertor
    {
        public void Image_resize(string input_Image_Path, string output_Image_Path, int new_Width)
        {
            ...
            const long quality = 40L;
              Bitmap source_Bitmap = new Bitmap("F:\p\Shop.Project_daneshgae\wwwroot\Products\0ce839f41e7641aeb448.jpg");
        ...
        public void Image_resizes(string Image_Path, string output_Image_Path, int new_Width,int new_Height)
        {

            const long quality = 40L;
            

            Bitmap source_Bitmap = new Bitmap(Image_Path);
